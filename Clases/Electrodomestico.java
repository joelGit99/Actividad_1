...
public class Electrodomestico {
	...
	/**
	 * Método que suma el precio dependiendo del consumo energético y del peso
	 * 
	 */
	...
	public String toString() {
		return "Electrodomestico [PRECIO BASE=" + DF.format(precioBase) + "€" + ", COLOR=" + color
				+ ", CONSUMO ENERGÉTICO=" + consEnergetico + ", PESO=" + peso + "kg" + "]";
	}
